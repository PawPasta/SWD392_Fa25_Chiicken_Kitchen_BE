...
interface IngredientService : BaseService<IngredientResponse, IngredientDetailResponse, 
CreateIngredientRequest, UpdateIngredientRequest, Long> {
    fun changeStatus(id: Long): IngredientResponse
}
