...
interface CategoryService : BaseService<CategoryResponse, CategoryDetailResponse,
        CreateCategoryRequest, UpdateCategoryRequest, Long> {
    fun changeStatus(id: Long): CategoryResponse
}
